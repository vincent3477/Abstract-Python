# -*- coding: utf-8 -*-
"""Homework_13_test.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1qI19tqQY5bjO6O81KW1tU1yJeyaNa3AE
...
def dependency_scheduler_redo(self, t):
    ...
    for i in self.successors[t]:
      self.completed_tasks.discard(i)
      tandsuccessors.update(i)
    return tandsuccessors
...
def dependency_scheduler_cooking_redo(self, v):
    ...
    # YOUR CODE HERE
    preandsub = self.predecessors[v] | self.successors[v]
...
class AND_OR_Scheduler(object):
    ...
    def add_and_task(self, t, dependencies):
        ...
        # YOUR CODE HERE
        assert t not in self.orTasks or len(self.predecessors[t]) == 0
        self.andTasks.add(t)
        self.allTasks.add(t)
        self.allTasks.update(dependencies)
        self.predecessors[t] = set(dependencies)
    ...
    def add_or_task(self, t, dependencies):
        ...
        # YOUR CODE HERE
        assert t not in self.andTasks or len(self.predecessors[t]) == 0
        self.orTasks.add(t)
        self.allTasks.add(t)
        self.allTasks.update(dependencies)
        self.predecessors[t] = set(dependencies)
    ...
    def available_tasks(self):
        ...
        completed."""
        # YOUR CODE HERE
        incompleteTasks = self.allTasks - self.completed_tasks
        availTasks1 = set()
        for i in incompleteTasks:
          if i in self.orTasks:
    ...
    def mark_completed(self, t):
        ...
        previously done) once t is completed."""
        # YOUR CODE HERE
        print(self.successors[t])
        availTasks2 = set()
        self.completed_tasks.add(t)
        for i in self.successors[t]:
          if i in self.orTasks:
            for j in self.predecessors[i]:
              if j in self.completed_tasks and i not in self.completed_tasks:
                availTasks2.add(i)
          if i in self.andTasks:
            if self.predecessors[i].issubset(self.completed_tasks):
              availTasks2.add(i)
        return availTasks2
