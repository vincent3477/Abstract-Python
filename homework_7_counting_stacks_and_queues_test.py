# -*- coding: utf-8 -*-
"""Homework_7_Counting_Stacks_and_Queues_test.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1SiahsD7iFX01dk5Ot7f77pEGlqPC5OPD
...
class CountingQueue(object):
    ...
    def __init__(self):
        self.queue = [] #each list items consists of a tuple.
...
def counting_queue_getitem(self, n):
    ...
    if type(n) is not int:
      raise TypeError('Wrong input. Input must be of type int.')
    if n >= counting_queue_len(self) or n < -counting_queue_len(self):
      raise IndexError('Index out of bounds')


    count = 0
    negativeCount = -counting_queue_len(self)

    for i in self.queue:
      for j in range(0,i[1]):
        if count == n or negativeCount == n:
          return i[0]
        count+=1
        negativeCount += 1
